...
export const changeUser = function (
  state: AState,
  action: UserActions
): AState {
  return {
...
export const changeColName = function (
  state: AState,
  action: ColumnAction
): AState {
...
export const addCard = function (state: AState, action: CardAction): AState {
  ...
  return {
    ...
    cards: [
      ...state.cards,
      { id: id, name: name, desc: desc, author: author, idColumn: columnId },
    ],
  };
};
...
export const addComm = function (state: AState, action: СommAction): AState {
  ...
  return {
    ...
    comments: [
      ...state.comments,
      { id: id, author: author, content: content, idCard: cardId },
    ],
  };
};
...
export const popupChange = function (
  state: AState,
  action: PopupAction
): AState {
